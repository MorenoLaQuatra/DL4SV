...
All the material for the course is available in this repository. The slides and the notebooks are available in the `slides` and `notebooks` folders, respectively.